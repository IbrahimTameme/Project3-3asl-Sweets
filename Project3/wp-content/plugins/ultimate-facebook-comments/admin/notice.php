...
function ufc_rating_admin_notice() {
    ...
    if ( ufc_plugin_get_installed_time() > strtotime( '-240 hours' )
        ...
        || apply_filters( 'ufc_plugin_hide_sticky_notice', false ) ) {
        return;
    }
    ...
    <div class="notice notice-success">
        <p><?php _e( 'Hey, I noticed you\'ve been using Ultimate Social Comments for more than 1 week – that’s awesome! Could you please do me a BIG favor and give it a <strong>5-star</strong> rating on WordPress? Just to help me spread the word and boost my motivation.', 'ultimate-facebook-comments' ); ?></p>
        ...
        <a href="<?php echo $dismiss; ?>" class="dismiss"><strong><?php _e( 'I don\'t want to rate', 'ultimate-facebook-comments' ); ?></strong></a></p>
    </div>
<?php
}
